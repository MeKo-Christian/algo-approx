...
func TestPower64(t *testing.T) {
	tests := []struct {
		...
		{"10^0.5", 10.0, 0.5, 3.16227766016838, 1e-8},
		{"e^1", math.E, 1.0, math.E, 1e-8},
		{"2^-2", 2.0, -2.0, 0.25, 1e-10},
		{"0.5^2", 0.5, 2.0, 0.25, 1e-10},
		{"4^0.5", 4.0, 0.5, 2.0, 1e-10},
		{"27^(1/3)", 27.0, 1.0 / 3.0, 3.0, 1e-8},
	}
...
func TestRoot64(t *testing.T) {
	tests := []struct {
		...
		{"cbrt(8)", 8.0, 3, 2.0, 1e-8},
		{"cbrt(27)", 27.0, 3, 3.0, 1e-8},
		{"4th root(16)", 16.0, 4, 2.0, 1e-8},
		{"5th root(32)", 32.0, 5, 2.0, 1e-8},
		{"sqrt(2)", 2.0, 2, 1.4142135623730951, 1e-10},
	}
